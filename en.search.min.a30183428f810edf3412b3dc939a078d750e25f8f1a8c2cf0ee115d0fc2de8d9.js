...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.57de59eb714afad913b917f1a7037de88a98ba0a83a901dc4932f5868bfa22db.js',function(){input.required=false;search();});}

...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.1dcd0d7444c0023bb4802a8d2222786249d52076664a68770de52a1fa55cd006.js',function(){input.required=false;search();});}

...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.d48881617ba4764f9fc27fc90037cf21b38511a94807024ad915013a3eb76fce.js',function(){input.required=false;search();});}

...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.caca19a4ed2521296a53bac400c1c54a6d7783d0826025620c8d04193143a354.js',function(){input.required=false;search();});}

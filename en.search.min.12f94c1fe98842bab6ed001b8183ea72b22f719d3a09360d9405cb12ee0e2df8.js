...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.aab7a4c79836625ede274318d1ec29d58318b3b130485f4895d657c8263ec7aa.js',function(){input.required=false;search();});}

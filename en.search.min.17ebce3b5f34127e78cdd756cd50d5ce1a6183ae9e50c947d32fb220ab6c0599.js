...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.773d7eb980c27b7cb2d870862a80e4f74ece10c64a3a32f7cc815d192604d802.js',function(){input.required=false;search();});}

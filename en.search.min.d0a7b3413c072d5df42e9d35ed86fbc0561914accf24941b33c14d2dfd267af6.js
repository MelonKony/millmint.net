...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.877a2fb198b1d9b59add6f7a793fc299a655db538df7c9b64305164048f7b692.js',function(){input.required=false;search();});}

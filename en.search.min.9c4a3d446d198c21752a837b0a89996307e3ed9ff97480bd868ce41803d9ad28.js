...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.2af73f5c9febabe69bf50fc3d03dfde089d9decf2b84dce113b139aded79d447.js',function(){input.required=false;search();});}

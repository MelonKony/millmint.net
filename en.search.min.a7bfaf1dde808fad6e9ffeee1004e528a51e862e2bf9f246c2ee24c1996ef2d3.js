...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.b7d5a4b9085dada86e6ca9c0deaa4bb659af2ee5cd097d0bf4fe711230e8ef02.js',function(){input.required=false;search();});}

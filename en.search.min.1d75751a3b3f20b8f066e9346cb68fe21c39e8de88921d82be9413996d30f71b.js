...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.15d0577077304f9fb6caf94b095260457036c261a7381990580c756ce9af66db.js',function(){input.required=false;search();});}

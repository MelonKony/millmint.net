...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.dc0d2678621b6d18328fdf32cd0714d7acab57a258096e2f73bc0fd4e9ff1beb.js',function(){input.required=false;search();});}

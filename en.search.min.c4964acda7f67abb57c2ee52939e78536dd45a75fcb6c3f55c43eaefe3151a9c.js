...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.e48f411bb8056b51fb4af95b20acbb449065622523ee25a5bffca1cd1a085318.js',function(){input.required=false;search();});}

...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f73d7bdde145242b80da143d252ef209477a0b3a090deff9ba3d4b18de0a9633.js',function(){input.required=false;search();});}

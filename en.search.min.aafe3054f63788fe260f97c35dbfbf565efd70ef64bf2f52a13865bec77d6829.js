...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.88a4f9afcf36a5e9dafaef55d0be25b6d56692b6214669b2a768d75a323330be.js',function(){input.required=false;search();});}

...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.b20096a49cd46f588e7cd4b86fc41ae39717e1e623d110222294ebe927b33d8f.js',function(){input.required=false;search();});}

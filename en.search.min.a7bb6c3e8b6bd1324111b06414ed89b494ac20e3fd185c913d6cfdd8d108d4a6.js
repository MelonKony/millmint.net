...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.35723c54c907d4cadf46ba7a750a632743c4e4562be83cf170a2ab905cfceade.js',function(){input.required=false;search();});}

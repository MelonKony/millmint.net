...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.0c86df2f1e551898eab61548304b3c8581ee98009032861595db8f92d1fd1cde.js',function(){input.required=false;search();});}

...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.97fad0d95055018cd829537acf1c3d0c1ec8b43efe90a767299a1ef7ddea4c2f.js',function(){input.required=false;search();});}

...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.72d4378434b14cb020d11cc859a49b1d6d7fdd354ba581d04667fa5be0c3ab5e.js',function(){input.required=false;search();});}

...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.be87929e0536b1d80f109d7b2b09db7703c475d8dc1662ef4b33ab1ae74a93b4.js',function(){input.required=false;search();});}

...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.924553662366420cef0f9eb603833f65a5949168796863d361431ca3520db569.js',function(){input.required=false;search();});}

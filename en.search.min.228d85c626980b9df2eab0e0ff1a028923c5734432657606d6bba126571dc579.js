...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.52a9a86dbf7abf3d1acd010036550aee1f57311de14b6668ef475facadec4efc.js',function(){input.required=false;search();});}

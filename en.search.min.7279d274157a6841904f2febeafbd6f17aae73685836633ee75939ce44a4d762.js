...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f6bd3f06d47f6c4885d2ae0449f8bb8aaa8752e3cca01ff4ed90aac176aa9fa9.js',function(){input.required=false;search();});}

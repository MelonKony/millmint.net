...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.10efb269b53698a2bd64776b4fcb8d948c32aae12ab8aa36a3b39f5a8e63c9e1.js',function(){input.required=false;search();});}

...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.661e7229c9ebed8acdfc7abf6740583c8f05ba7a6a1bff4d98d4b3bf7665cefa.js',function(){input.required=false;search();});}

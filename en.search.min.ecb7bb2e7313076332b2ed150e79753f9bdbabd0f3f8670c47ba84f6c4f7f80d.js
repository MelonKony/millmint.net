...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.b2fb86419e9df3a7bdc6ea90b90de63a5c1e8917ec8abe71b2ccf51c0088fff3.js',function(){input.required=false;search();});}

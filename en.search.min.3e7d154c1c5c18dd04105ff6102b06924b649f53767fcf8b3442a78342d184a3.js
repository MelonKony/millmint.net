...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.01372a5625202b5936691d8e7eaec5f1827bbd0b3da7006332839bfdd65cc6ba.js',function(){input.required=false;search();});}

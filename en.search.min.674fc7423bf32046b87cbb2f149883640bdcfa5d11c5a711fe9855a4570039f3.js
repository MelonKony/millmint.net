...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.650ea7deec576a333212e31ca331b282926df17336d07af53a2ffa3687d28fc4.js',function(){input.required=false;search();});}

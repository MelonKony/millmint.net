...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f7731aefbb1e76443f971f9899fb2ec40d72a2b41646a56332163a913d14b433.js',function(){input.required=false;search();});}

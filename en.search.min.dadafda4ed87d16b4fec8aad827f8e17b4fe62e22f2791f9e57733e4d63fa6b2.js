...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.345a29e46a92d522a8595e46c953421023a474ac23a196b230cd911e96bbadcc.js',function(){input.required=false;search();});}

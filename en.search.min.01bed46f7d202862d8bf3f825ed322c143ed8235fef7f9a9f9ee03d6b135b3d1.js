...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3e717a360ff56fe7d9e5160f66090971d0d8f0d3f8433beaf145543596a9b2e3.js',function(){input.required=false;search();});}

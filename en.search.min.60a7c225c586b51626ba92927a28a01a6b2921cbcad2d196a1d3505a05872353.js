...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.7b965ef57e7839570d3ffecfd3f7f692952ebca229ef99d6aced7580a3b992a1.js',function(){input.required=false;search();});}
